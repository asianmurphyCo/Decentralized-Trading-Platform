    ...
    return (
        ...
        {/* NAVBAR */}
            <Navbar expand="lg" className="header my-3">
                <Container>
                    <Navbar.Brand href="#" className='text-white me-5'><strong>AsianMurphy</strong></Navbar.Brand>
                    ...
                    >
                        ...
                        <Nav.Link href="#action2" className='text-white headerItem mx-3'>Dashboard</Nav.Link>
                    ...
                    <a href="#"><button type="button" className='btn btn-primary btn-color mx-2 my-2'><strong>Connect Wallet</strong></button></a>
                    </Navbar.Collapse>
                </Container>
            </Navbar>
        </div>
